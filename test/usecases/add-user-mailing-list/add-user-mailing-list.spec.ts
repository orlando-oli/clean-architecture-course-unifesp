...
import { AddUserToMailingList } from '../../../src/usecases/add-user-mailing-list/add-user-mailing-list';
import { UserRepository } from '../../../src/usecases/add-user-mailing-list/ports/user-repository';
